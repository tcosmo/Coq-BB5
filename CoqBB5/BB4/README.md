...
Proving this results involves enumerating 4-state 2-symbol Turing machines and decide for each whether it halts or not and, if it halts, that it halts after at most 107 steps.
